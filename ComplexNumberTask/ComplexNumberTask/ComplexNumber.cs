...
namespace ComplexNumberTask
{
    ...
    public class ComplexNumber
    {
        ...
        {
            ComplexNumber complexNumber = new ComplexNumber();
            double commonPart = secondComplexNumber.RealPart * secondComplexNumber.RealPart + 
                                secondComplexNumber.ImaginaryPart * secondComplexNumber.ImaginaryPart;

            complexNumber.RealPart = (firstComplexNumber.RealPart * secondComplexNumber.RealPart + 
                                      firstComplexNumber.ImaginaryPart * secondComplexNumber.ImaginaryPart) / commonPart;
            complexNumber.ImaginaryPart = (firstComplexNumber.ImaginaryPart * secondComplexNumber.RealPart - 
                                           firstComplexNumber.RealPart * secondComplexNumber.ImaginaryPart) / commonPart;
            return complexNumber;
        }
